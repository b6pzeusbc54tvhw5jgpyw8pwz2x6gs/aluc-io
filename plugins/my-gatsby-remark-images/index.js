// based on https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-remark-images 3.0.10
    ...
    const generateImagesAndUpdateNode = async function(
      ...
      const wrapperStyle =
        typeof options.wrapperStyle === `function`
          ? options.wrapperStyle({ ...fluidResult, query: getImageInfo(node.url).query })
